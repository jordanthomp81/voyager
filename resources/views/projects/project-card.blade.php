@foreach ($projects as $project)
  ...
  <a href="{{ route('projects.show', ['id' => $project->id]) }}" class="dashboard-content-project">
    ...
    <p class="dashboard-content-project-subtasks">4 Tasks</p>

    <h2>{{ $project->name }}</h2>

    <p class="dashboard-content-project-description">{{ $project->description }}</p>
    ...
    <div class="dashboard-content-project-controls-container">
      ...
      <p class="dashboard-content-project-controls-members">{{ $project->members }} Members</p>
