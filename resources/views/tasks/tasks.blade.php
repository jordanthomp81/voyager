      ...
      <div class="content-inner-split-container">
        ...
        <div class="task-content-inner-split-container">
          ...
          <div class="task-content-container">
            ...
            @foreach ($tasks as $indexKey => $task)
              ...
              @if($task->completed != 1)
                  ...
                  @if($task->deadline != null)
                    ...
                    @if($task->deadline == explode(' ', $today)[0])
                      <?php
            ...
            <h2 class="task-sub-title">This Week<?php echo ' (' . count($taskWeeks) . ')'; ?></h2>

            @foreach ($taskWeeks as $indexKey => $taskWeek)

              @if($taskWeek->completed != 1)

                @if($taskWeek->deadline != null)

                  <?php
                  $temptaskId = 'tasks/' . $taskWeek->id;
                  $taskWeek->description = substr($taskWeek->description, 0, 80) . '...';
                  ?>
            ...
            <h2 class="task-sub-title"><?php echo "All Tasks (" . count($tasks) . ")"; ?></h2>
